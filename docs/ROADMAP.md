...
The current release is [v0.5.3](https://github.com/michaelmonetized/omadesign/releases/tag/v0.5.3). Paste screenshots, copied image files, browser images, text, and SVG into the visible canvas center. Objects copied inside Omadesign keep their original positions. [v0.5.1](https://github.com/michaelmonetized/omadesign/releases/tag/v0.5.1) made Pixel selections visible and kept paint inside them. [v0.5.0](https://github.com/michaelmonetized/omadesign/releases/tag/v0.5.0) added the Layout persona, opt-in cloud comments, and a public showcase at [omadesign.app](https://omadesign.app). Studio notes live at [omadesign.app/updates](https://omadesign.app/updates). Layered interchange, RAW development, batch looks, rotated nodes and flips remain.
